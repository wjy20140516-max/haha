...
class TB_Mem_Ext_Populate_2pTrim_DataDIS_vhhtrim :
	public TestItem, private BaseItemOperation
{
public:
	TB_Mem_Ext_Populate_2pTrim_DataDIS_vhhtrim(TestItemExecuteContext * aContext);
	~TB_Mem_Ext_Populate_2pTrim_DataDIS_vhhtrim();
protected:
	/**
	* Init test
	*/
