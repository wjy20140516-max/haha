...
#include "TB_Mem_Ext_Write_FF00h_DDW.h"
#include "Common.h"
...
* Run test
*/
void TB_Mem_Ext_Write_FF00h_DDW::Run(TestItemExecuteContext * aContext) {
	this->UserRun(aContext);
	//Add code here

    //this->Info("[Test Item] TB_Mem_Ext_Write_FF00h_DDW -- started");
    ...
    {
    (*item)->SetValue(1);
    TB_Mem_Ext_Write_FF00h_DDW_1160[dut-1] = 1;
    }
    }
    DUT_LOOP_END
    }
    //this->Info("[Test Item] TB_Mem_Ext_Write_FF00h_DDW -- end");
    }

/**
* Constructor
*/
TB_Mem_Ext_Write_FF00h_DDW::TB_Mem_Ext_Write_FF00h_DDW(TestItemExecuteContext * aContext) : TestItem("TB_Mem_Ext_Write_FF00h_DDW", aContext){
...
* Destructor
*/
TB_Mem_Ext_Write_FF00h_DDW::~TB_Mem_Ext_Write_FF00h_DDW() {
	//DO NOT add code here unless necessary.
}
...
* Init test
*/
bool TB_Mem_Ext_Write_FF00h_DDW::Initialize(TestItemExecuteContext * aContext) {
...
* Exit test
*/
void TB_Mem_Ext_Write_FF00h_DDW::Exit(TestItemExecuteContext * aContext) {
...
* Pause test
*/
void TB_Mem_Ext_Write_FF00h_DDW::Pause(TestItemExecuteContext * aContext) {
...
* Resume test
*/
void TB_Mem_Ext_Write_FF00h_DDW::Resume(TestItemExecuteContext * aContext) {
...
* Stop test
*/
void TB_Mem_Ext_Write_FF00h_DDW::Stop(TestItemExecuteContext * aContext) {
...
* AfterBin test
*/
void TB_Mem_Ext_Write_FF00h_DDW::AfterBin(TestItemExecuteContext * aContext) {
...
*/
REGISTER_REFLECTABLE_TYPE_WITH_PARAMETER2(TB_Mem_Ext_Write_FF00h_DDW, TestItemExecuteContext *)
