...
#include "TB_Mem_Ext_Write_FFh_DDW.h"
#include "Common.h"
...
* Run test
*/
void TB_Mem_Ext_Write_FFh_DDW::Run(TestItemExecuteContext * aContext) {
	this->UserRun(aContext);
	//Add code here

    //this->Info("[Test Item] TB_Mem_Ext_Write_FFh_DDW -- started");
    ...
    //testlog.Info("[TR_RD_ERROR] Read T-Reg Add %02Xh = %02X", 0x03, TReg_ReadData[dutz]);
    (*item)->SetValue(1);
    TB_Mem_Ext_Write_FFh_DDW_1110[dut - 1] = 1;
    }
    else
    {
    (*item)->SetValue(0);
    TB_Mem_Ext_Write_FFh_DDW_1110[dut - 1] = 0;
    }
    }
    DUT_LOOP_END
    }
    //this->Info("[Test Item] TB_Mem_Ext_Write_FFh_DDW -- end");
    }

/**
* Constructor
*/
TB_Mem_Ext_Write_FFh_DDW::TB_Mem_Ext_Write_FFh_DDW(TestItemExecuteContext * aContext) : TestItem("TB_Mem_Ext_Write_FFh_DDW", aContext){
...
* Destructor
*/
TB_Mem_Ext_Write_FFh_DDW::~TB_Mem_Ext_Write_FFh_DDW() {
	//DO NOT add code here unless necessary.
}
...
* Init test
*/
bool TB_Mem_Ext_Write_FFh_DDW::Initialize(TestItemExecuteContext * aContext) {
...
* Exit test
*/
void TB_Mem_Ext_Write_FFh_DDW::Exit(TestItemExecuteContext * aContext) {
...
* Pause test
*/
void TB_Mem_Ext_Write_FFh_DDW::Pause(TestItemExecuteContext * aContext) {
...
* Resume test
*/
void TB_Mem_Ext_Write_FFh_DDW::Resume(TestItemExecuteContext * aContext) {
...
* Stop test
*/
void TB_Mem_Ext_Write_FFh_DDW::Stop(TestItemExecuteContext * aContext) {
...
* AfterBin test
*/
void TB_Mem_Ext_Write_FFh_DDW::AfterBin(TestItemExecuteContext * aContext) {
...
*/
REGISTER_REFLECTABLE_TYPE_WITH_PARAMETER2(TB_Mem_Ext_Write_FFh_DDW, TestItemExecuteContext *)
