...
class TB_Mem_Main_Read_DArch_vsInvCKB_DDWDIS :
	public TestItem, private BaseItemOperation
{
public:
	TB_Mem_Main_Read_DArch_vsInvCKB_DDWDIS(TestItemExecuteContext * aContext);
	~TB_Mem_Main_Read_DArch_vsInvCKB_DDWDIS();
protected:
	/**
	* Init test
	*/
